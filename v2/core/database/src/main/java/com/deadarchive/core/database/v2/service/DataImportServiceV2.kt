...
sealed class ImportResult {
    ...
    data class RequiresUserChoice(
        val availableSources: com.deadarchive.v2.core.database.service.DatabaseManagerV2.AvailableSources
    ) : ImportResult() {
        val success: Boolean = false
    }
    ...
    companion object {
        ...
        fun requiresUserChoice(sources: com.deadarchive.v2.core.database.service.DatabaseManagerV2.AvailableSources) = 

package com.deadly.v2.app.screens
...
import com.deadly.v2.feature.settings.SettingsViewModel

/**
 * BottomNavSettingsScreen - V2 Settings adapted for bottom navigation
 * 
 * This is an adapted version of the V2 SettingsScreen that works in a
 * bottom navigation context without requiring a back button.
 * 
...
fun BottomNavSettingsScreen(
    ...
    AppScaffold(
        ...
        topBarNavigationIcon = null  // No back button in bottom nav context
    ) { paddingValues ->
        LazyColumn(
            modifier = Modifier
                .fillMaxSize()

...
import com.deadly.core.model.PlayerV2RepeatMode
...
private fun collectPlayerV2DebugData(
    ...
    recordingId: String?
): com.deadly.core.design.component.DebugData {
    return com.deadly.core.design.component.DebugData(
        screenName = "PlayerV2Screen",
        sections = listOf(
            com.deadly.core.design.component.DebugSection(
                title = "PlayerV2 Debug",
                items = listOf(
                    com.deadly.core.design.component.DebugItem.KeyValue("Status", "Debug panel ready - add items as needed")
                )
            )
        )
    )

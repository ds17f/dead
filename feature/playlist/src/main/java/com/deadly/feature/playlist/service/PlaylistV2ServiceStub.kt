...
class PlaylistV2ServiceStub @Inject constructor() : PlaylistV2Service {
    ...
    override suspend fun getCurrentReviews(): List<com.deadly.feature.playlist.Review> {
        ...
        return listOf(
            com.deadly.feature.playlist.Review(
                username = "DeadHead87",
                rating = 5,
                stars = 5.0,
    ...
    override suspend fun getRecordingOptions(): com.deadly.feature.playlist.RecordingOptionsV2Result {
        ...
        val currentRecording = com.deadly.feature.playlist.RecordingOptionV2ViewModel(
        ...
        val alternatives = listOf(
            com.deadly.feature.playlist.RecordingOptionV2ViewModel(
        ...
        return com.deadly.feature.playlist.RecordingOptionsV2Result(

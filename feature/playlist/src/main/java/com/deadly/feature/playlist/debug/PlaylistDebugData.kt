...
import com.deadly.core.design.component.DebugItemFactory
...
private fun createLoadingStateSection(
    ...
    currentRecording: com.deadly.core.model.Recording?,
...
private fun createRecordingDataSection(currentRecording: com.deadly.core.model.Recording?): DebugSection {
    return DebugSection(
...
private fun createDownloadStateSection(downloadStates: Map<String, com.deadly.core.design.component.ShowDownloadState>): DebugSection {
    return DebugSection(

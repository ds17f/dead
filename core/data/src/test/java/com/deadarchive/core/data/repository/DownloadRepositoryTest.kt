...
class DownloadRepositoryTest {
    ...
    fun `can restart failed download`() = runTest {
        ...
        val concert = createTestConcert("gd1977", "Cornell")
        val failedDownload = mockk<com.deadarchive.core.database.DownloadEntity>(relaxed = true) {
    ...
    fun `does not interfere with active downloads`() = runTest {
        ...
        val concert = createTestConcert("gd1977", "Cornell")
        val activeDownload = mockk<com.deadarchive.core.database.DownloadEntity>(relaxed = true) {

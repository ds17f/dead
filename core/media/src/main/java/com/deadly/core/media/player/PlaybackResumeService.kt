...
import com.deadly.core.database.PlaybackHistoryEntity
...
class PlaybackResumeService @Inject constructor(
    ...
    private suspend fun restorePlayback(track: PlaybackHistoryEntity) {
        try {
            ...
            // Load the show into the queue starting at the track and position (without auto-playing)
            queueManager.loadShow(recording, trackIndex, track.finalPosition, autoPlay = false)
